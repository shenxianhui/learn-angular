(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('carousel-info', ['plugin-manager', '@angular/core', 'ng-zorro-antd', '@angular/common'], factory) :
    (global['carousel-info'] = factory(global.pluginManager,global.ng.core,global.ngZorroAntd,global.ng.common));
    ...
    var CarouselInfoComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CarouselInfoComponent.ctorParameters = function () {
            return [
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var CarouselInfoModule = /** @class */ (function () {
        function CarouselInfoModule() {
        }
...
//# sourceMappingURL=carousel-info.umd.js.map