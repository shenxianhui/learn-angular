(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('top-rank', ['plugin-manager', '@angular/core', 'ng-zorro-antd', '@angular/common'], factory) :
    (global['top-rank'] = factory(global.pluginManager,global.ng.core,global.ngZorroAntd,global.ng.common));
    ...
    var TopRankComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        TopRankComponent.ctorParameters = function () {
            return [
        ...
        TopRankComponent.propDecorators = {
            ...
            rowbodyDiv: [{ type: core.ViewChild, args: ["rowbody",] }]
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var TopRankModule = /** @class */ (function () {
        function TopRankModule() {
        }
...
//# sourceMappingURL=top-rank.umd.js.map