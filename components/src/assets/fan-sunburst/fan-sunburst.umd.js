(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('fan-sunburst', ['plugin-manager', '@angular/core', 'ng-zorro-antd', '@angular/common'], factory) :
    (global['fan-sunburst'] = factory(global.pluginManager,global.ng.core,global.ngZorroAntd,global.ng.common));
    ...
    var FanSunburstComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FanSunburstComponent.ctorParameters = function () {
            return [
        ...
        FanSunburstComponent.propDecorators = {
            fansunburstDiv: [{ type: core.ViewChild, args: ['fansunburst',] }]
        };
...
//# sourceMappingURL=fan-sunburst.umd.js.map